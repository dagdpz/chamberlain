function [x y z] = cl_plot_sagittal_slice_smaller(filename,xyz_mm, z_offset_mm, varargin)
...
% cl_plot_sagittal_slice_smaller(vmr, [x_mm y_mm z_mm], z_offset_mm, 'r', 'zoom', 2);
